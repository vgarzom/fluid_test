    ...
    function Simulator (wgl, onLoaded) {
        ...
        wgl.createProgramsFromFiles({
            transferToGridProgram: {
                vertexShader: shaders_url + 'transfertogrid.vert',
                fragmentShader: [shaders_url + 'common.frag', shaders_url + 'transfertogrid.frag'],
                attributeLocations: { 'a_textureCoordinates': 0}
            },
            normalizeGridProgram: {
                vertexShader: shaders_url + 'fullscreen.vert',
                fragmentShader: shaders_url + 'normalizegrid.frag',
                attributeLocations: { 'a_position': 0}
            },
            markProgram: {
                vertexShader: shaders_url + 'mark.vert',
                fragmentShader: shaders_url + 'mark.frag',
                attributeLocations: { 'a_textureCoordinates': 0}
            },
            addForceProgram: {
                vertexShader: shaders_url + 'fullscreen.vert',
                fragmentShader: [shaders_url + 'common.frag', shaders_url + 'addforce.frag'],
                attributeLocations: { 'a_position': 0}
            },
            enforceBoundariesProgram: {
                vertexShader: shaders_url + 'fullscreen.vert',
                fragmentShader: [shaders_url + 'common.frag', shaders_url + 'enforceboundaries.frag'],
                attributeLocations: { 'a_textureCoordinates': 0 }
            },
            extendVelocityProgram: {
                vertexShader: shaders_url + 'fullscreen.vert',
                fragmentShader: shaders_url + 'extendvelocity.frag',
                attributeLocations: { 'a_textureCoordinates': 0 }
            },
            transferToParticlesProgram: {
                vertexShader: shaders_url + 'fullscreen.vert',
                fragmentShader: [shaders_url + 'common.frag', shaders_url + 'transfertoparticles.frag'],
                attributeLocations: { 'a_position': 0}
            },
            divergenceProgram: {
                vertexShader: shaders_url + 'fullscreen.vert',
                fragmentShader: [shaders_url + 'common.frag', shaders_url + 'divergence.frag'],
                attributeLocations: { 'a_position': 0}
            },
            jacobiProgram: {
                vertexShader: shaders_url + 'fullscreen.vert',
                fragmentShader: [shaders_url + 'common.frag', shaders_url + 'jacobi.frag'],
                attributeLocations: { 'a_position': 0}
            },
            subtractProgram: {
                vertexShader: shaders_url + 'fullscreen.vert',
                fragmentShader: [shaders_url + 'common.frag', shaders_url + 'subtract.frag'],
                attributeLocations: { 'a_position': 0}
            },
            advectProgram: {
                vertexShader: shaders_url + 'fullscreen.vert',
                fragmentShader: [shaders_url + 'common.frag', shaders_url + 'advect.frag'],
                attributeLocations: { 'a_position': 0}
            },
            copyProgram: {
                vertexShader: shaders_url + 'fullscreen.vert',
                fragmentShader: shaders_url + 'copy.frag',
                attributeLocations: { 'a_position': 0}
            }
        }, (function (programs) {
